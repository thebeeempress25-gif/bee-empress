    ...
    <div className="min-h-screen bg-white">
      <section className="relative py-24 bg-gradient-to-r from-[#FFF9F2] to-[#F4EDE6]">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="font-serif text-5xl md:text-6xl text-[#1F2124] mb-4">Get in Touch</h1>
        ...
        <div className="grid md:grid-cols-2 gap-16">
          ...
          <div className="space-y-8">
            <div className="bg-[#F4EDE6] p-8 rounded-xl">
              <h3 className="font-serif text-2xl text-[#1F2124] mb-8">Other Ways to Reach Us</h3>
            ...
            <div className="bg-[#F4EDE6] p-8 rounded-xl">
              <h3 className="font-serif text-xl text-[#1F2124] mb-6">Business Hours</h3>
            ...
            <div className="bg-gradient-to-br from-[#D69C4A] to-[#c28a3a] text-white p-8 rounded-xl">
              <h4 className="font-serif text-lg mb-2">Quick Response</h4>
